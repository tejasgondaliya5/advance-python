from threading import Thread, currentThread, Lock, RLock,Semaphore, BoundedSemaphore

class Flight:
    def __init__(self, Available_seat):
        self.Available_seat = Available_seat
        self.l = BoundedSemaphore(2)                                # semaphore ma jetli value api hoy tetla ne Thread ne access male
        # semaphore ma 2 api e etle Thread ma 2 thread ek sathe access melvi sake.
        print(self.l)
